...
public class TestShape {
    public static void main(String[] args) {
        ...
        System.out.println(" Total perimeter of both circles is " + (c1.perimeter() + c2.perimeter()));
        ...
        System.out.println( " Total number of Circle objects created is " + Circle.getCircleCount());
    }
}
